  ...
  <div className="add-image" onClick={(e)=>setnotetoggle(!notetoggle)}>
        ...
        <div style={{position:'relative'}}>
          {Array.from(Attachment)?.map((a)=>{
            ...
            return <img key={a?.name} src={URL.createObjectURL(a)} alt='cc' width={150} height={150} style={{objectFit:'contain'}} />
          })}
        ...
        <img src={URL.createObjectURL(signature)} alt='cc' width={150} height={150} style={{objectFit:'contain'}} />
