  ...
  return (
    <div className='padding4rem' >
      ...
      {image == null ?   <div className="add-image" onClick={():void=>document.getElementById("hidden-input")?.click()}>
        ...
        <img src={URL.createObjectURL(image)} alt='cc' width={200} height={200} style={{objectFit:'contain'}} />
      ...
      <Item notetoggle={notetoggle} setnotetoggle={setnotetoggle} print={false} Attachment={Attachment} setnote={setnote} note={note} setAttachment={setAttachment} signature={signature} setSignature={setSignature} noofinput={noofinput} setnoofinput={setnoofinput} item={item} setitem={setitem}/>
...
<button className='btn-color' style={{background:"#dc5c5c"}} onClick={handlePrint}>Print your invoice</button>
      ...
      <div className='invoice-div'>
        <span >INVOICE DATE </span>
        <input type="text" defaultValue={invoice?.date} style={{borderBottom:'none'}} className=''></input>
      </div>
      ...
      <Item notetoggle={notetoggle} setnotetoggle={setnotetoggle} setnote={setnote} note={note}  print={true} Attachment={Attachment} setAttachment={setAttachment} signature={signature} setSignature={setSignature} noofinput={noofinput} setnoofinput={setnoofinput} item={item} setitem={setitem}/>
      <p style={{margin:' 2rem auto 2rem auto',width:'fit-content',color:'grey'}}>Generated by Techninza </p>
      </div>
      </div>
